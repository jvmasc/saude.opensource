...
## TEMPERATURA BASAL — O Marcador Mais Importante
...
```
PROTOCOLO (Teste de Broda Barnes):
...
|-------------|-------------|------|
| **< 36.0°C** | Hipotireoidismo severo | Investigar, considerar acompanhamento médico |
...
```
✓ Redução de gases, inchaço, constipação
...
```
✓ Redução de inflamação (menos dor articular)
...
| Período | Sinais Esperados | Temperatura Basal |
|---------|------------------|-------------------|
| **Dias 1-3** | Possível adaptação, leve desconforto | Sem mudança |
| **Dias 3-7** | Energia matinal melhorando | Pode cair (detox) |
| **Dias 7-14** | Digestão melhorando, menos inchaço | Estabilizando |
| **Dias 14-21** | Clareza mental, humor estabilizando | Início de elevação |
| **Dias 21-30** | Metabolismo acelerando, peso estabilizando | +0.1-0.2°C |
| **Dias 30-60** | Mudanças visíveis (pele, cabelo, unhas) | +0.2-0.3°C |
| **Dias 60-90** | Restauração profunda, energia sustentável | 36.5-36.8°C |
...
```
PARÂMETRO          | ANTES (Data:___) | DEPOIS (Data:___)
-------------------|------------------|------------------
...
### Se temperatura basal NÃO subiu em 4 semanas:
...
### Se energia NÃO melhorou em 2 semanas:
...
**[← Protocolo Mestre](/pt/docs/protocolo-mestre/)** | **[FAQ](protocolo-mestre/faq/)** | **[Casos Clínicos](protocolo-mestre/casos-clinicos/)**
