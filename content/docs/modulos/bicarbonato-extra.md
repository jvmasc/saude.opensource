...
> **Módulo do [Protocolo Mestre]({{< relref "/docs/protocolo-mestre/_index.md" >}})** — Deep Dive em Bicarbonato de Sódio
...
**[← Módulos]({{< relref "/docs/modulos/_index.md" >}})** | **[Protocolo Mestre]({{< relref "/docs/protocolo-mestre/_index.md" >}})** | **[Água Oxigenada]({{< relref "/docs/modulos/agua-oxigenada.md" >}})**
