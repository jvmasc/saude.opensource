...
> **Módulo do [Protocolo Mestre]({{< relref "/docs/protocolo-mestre/_index.md" >}})** — Deep Dive em Remineralização
...
**O que é:**
Remineralização é a **reposição dos minerais essenciais** que o corpo não consegue produzir e que estão em falta devido ao solo empobrecido, água filtrada e alimentação industrializada. São os **cofatores de centenas de enzimas** — sem eles, reações bioquímicas falham.

**Estatística chocante:**
- **75% da população** é deficiente em magnésio
- **42% dos americanos** têm deficiência de vitamina D
- **31% das mulheres** são deficientes em ferro
- Solo agrícola perdeu **85% dos minerais** nos últimos 100 anos

**Erro #1 mais comum:**
Suplementar **doses baixas** ou **formas erradas** (ex: óxido de magnésio tem 4% de absorção vs. glicinato com 80%).
...
- Semana 3-4: Energia subindo, humor estabilizando
- Mês 2: Imunidade fortalecendo
- Mês 3+: Benefícios consolidados
...
**Por que é essencial:**
- Tecnicamente é um **hormônio**, não vitamina
- Regula **2000+ genes**
- **42% dos adultos** são deficientes
- Sol é a fonte primária, mas exposição moderna é insuficiente

**Funções principais:**
- Sistema imune (primeira linha de defesa)
- Absorção de cálcio (ossos)
- Humor e cognição
- Regulação hormonal
- Anti-inflamatório
...
**Sinais de deficiência:**
- Fadiga crônica
- Depressão, especialmente sazonal
...
**Por que é essencial:**
- Cofator de **300+ enzimas**
- Essencial para **imunidade** (células T, NK)
- Crítico para **hormônios** (testosterona, tireoide)
- **25% da população mundial** é deficiente

**Funções principais:**
- Sistema imune (primeira linha)
- Síntese de testosterona
- Saúde da pele e cabelo
- Cicatrização de feridas
- Sentido de paladar e olfato
- Síntese de DNA
...
**Por que é essencial:**
- **Componente estrutural** do cérebro (60% é gordura)
- Precursor de **resolvinas** (resolvem inflamação)
- Proporção Ômega-6:Ômega-3 moderna é **20:1** (ideal: 2:1)
- Dieta moderna é **extremamente deficiente**
...
- Saúde cardiovascular (triglicerídeos)
- Função cerebral (humor, cognição)
- Saúde ocular
- Articulações
- Pele saudável
...
- Conduzem **impulsos elétricos** (nervos, coração)
- Regulam **hidratação celular**
- Mantêm **pH sanguíneo**
- Perdidos no **suor, urina, stress**
...
> Para lista completa: **[Ver Screening]({{< relref "/docs/ferramentas/SCREENING-v2.md" >}})**

**Sintomas de Alarme:**

- 🚨 **Palpitações persistentes** (pode ser eletrólitos)
- 🚨 **Fraqueza muscular severa** (potássio baixo)
- 🚨 **Confusão mental aguda** (sódio/magnésio)
- 🚨 **Formigamento persistente** (B12, cálcio)
- 🚨 **Diarreia severa** (excesso de magnésio)
- 🚨 **Náusea intensa** (excesso de zinco/ferro)
...
1. **Dr. Carolyn Dean** — *The Magnesium Miracle*
   - Referência definitiva sobre magnésio

2. **Dr. James DiNicolantonio** — *The Salt Fix*
   - Reabilitação do sal na saúde

3. **Dr. Michael Holick** — *The Vitamin D Solution*
...
5. **DiNicolantonio JJ, et al.** — *Subclinical magnesium deficiency: a principal driver of cardiovascular disease* (Open Heart, 2018)

6. **Holick MF** — *Vitamin D deficiency* (NEJM, 2007)

7. **Prasad AS** — *Zinc: role in immunity, oxidative stress and chronic inflammation* (Curr Opin Clin Nutr Metab Care, 2009)
