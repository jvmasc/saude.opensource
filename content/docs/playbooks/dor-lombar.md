...
**Se tem red flags → Médico PRIMEIRO**
...
**O que é:**
Dor na região lombar (parte baixa das costas). Raramente é "só lombar" — geralmente é compensação de rigidez ou fraqueza em outro lugar.

**Erro #1 mais comum:**
Tratar apenas o local da dor (anti-inflamatório, massagem local) sem corrigir a **causa raiz** (glúteos fracos, isquiotibiais rígidos, psoas encurtado).
...
**Resultado esperado:**
Redução de 40-60% da dor em 7-14 dias.
...
**Fisiopatologia:**
Lombar compensa por fraqueza/rigidez em glúteos, isquiotibiais, psoas → sobrecarga → espasmo muscular → dor.
...
**Fisiopatologia:**
Anterior pelvic tilt (pelve inclinada para frente) → lombar hiper-arqueada → compressão facetas articulares → dor.
...
**Fisiopatologia:**
Disco intervertebral herniado (núcleo pulposo extravasa) → comprime raiz nervosa → dor irradiada (ciática).
...
**Fisiopatologia:**
Autoimunidade → inflamação articulações sacroilíacas e coluna → fusão óssea progressiva.
...
O **[Protocolo Mestre (Shot dos Campeoes)](/pt/docs/protocolo-mestre/)** auxilia na dor lombar atraves de:
