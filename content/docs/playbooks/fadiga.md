...
**Se tem contraindicação → Médico PRIMEIRO**
...
**TSH >4.5 ou T3/T4 baixos:**
→ Veja Tipo 2 (Fadiga Tireoidiana) abaixo
→ Considerar avaliação médica para levotiroxina

**Anti-TPO positivo (Hashimoto):**
→ Protocolo especial: eliminar glúten, selênio 200mcg, vitamina D
→ Regenerar intestino (Protocolo 4R)
→ Link: **[[Protocolo de Iodo - Seção Hashimoto]]**

**TSH 2.5-4.5 ("subclínico"):**
→ Protocolo nutricional PODE resolver:
- Iodo 150-300mcg/dia (SE anti-TPO negativo)
- Selênio 200mcg/dia
- Zinco 30mg/dia
- Ashwagandha 600mg/dia
→ Reteste em 8-12 semanas
...
**O que é:**
Cansaço persistente que não melhora com descanso. Não é preguiça — é falha sistêmica de geração ou uso de energia (ATP).

**Erro #1 mais comum:**
Achar que é "só stress" ou "falta de café". Fadiga crônica tem **causa bioquímica**.
...
**Resultado esperado:**
Melhora de 30-50% da energia em 2-4 semanas.
...
**Fisiopatologia:**
Mitocôndrias disfuncionais → produção inadequada de ATP → todas células sem energia.
...
**Fisiopatologia:**
Tireoide produz hormônios (T4 → T3) que regulam metabolismo. Se baixos → tudo desacelera.
...
**Fisiopatologia:**
Hemoglobina insuficiente → transporte de O₂ reduzido → células sem oxigênio → sem ATP.
...
**Fisiopatologia:**
Eixo HPA cronicamente ativado → cortisol desregulado (alto → resistência → baixo → exaustão).
...
**Fisiopatologia:**
Metais pesados, micotoxinas, pesticidas → disfunção mitocondrial + sobrecarga hepática + inflamação.
...
**Fisiopatologia:**
Inflamação crônica → citocinas inflamatórias (IL-6, TNF-α) → fadiga sistêmica.
...
O **[Protocolo Mestre (Shot dos Campeoes)](/pt/docs/protocolo-mestre/)** aborda diretamente as causas raiz da fadiga:
