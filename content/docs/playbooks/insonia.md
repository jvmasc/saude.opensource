...
**Se tireoide alterada → Veja seção abaixo**
...
**O que é:**
Dificuldade de iniciar ou manter o sono, resultando em fadiga diurna. Não é "só stress" — é desregulação circadiana + neuroquímica.

**Erro #1 mais comum:**
Usar telas à noite (luz azul bloqueia melatonina), tomar café após 14h, ou não ter rotina de sono.
...
**Resultado esperado:**
Melhora de 50-70% da qualidade do sono em 7-14 dias.
...
**Fisiopatologia:**
Sistema nervoso simpático dominante ao deitar → cortisol elevado → mente acelerada → sem sono.
...
**Fisiopatologia:**
Hipoglicemia noturna → cortisol liberado (contraregulação) → acorda. Ou cortisol noturno elevado (stress crônico).
...
**Fisiopatologia:**
Cortisol baixo ao acordar (exaustão adrenal) → corpo não consegue sustentar sono. Ou depressão (serotonina baixa).
...
**Fisiopatologia:**
Sono fragmentado ou superficial → sem N3 (profundo) ou REM suficiente → não restaura.
...
O **[Protocolo Mestre (Shot dos Campeoes)]({{< relref "/docs/protocolo-mestre/_index.md" >}})** contem componentes que melhoram o sono:
...
- **[M2: Remineralizacao]({{< relref "/docs/modulos/remineralizacao.md" >}})** — Magnesio, glicina, B6 (cofatores do sono)
- **[M1: Iodo]({{< relref "/docs/modulos/iodo.md" >}})** — Se tireoide alterada afeta sono
- **[M4: Intestino]({{< relref "/docs/modulos/intestino.md" >}})** — Producao de serotonina → melatonina
